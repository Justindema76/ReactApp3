...
--
-- Host: localhost
-- Generation Time: Jan 08, 2025 at 11:50 AM
...
--
ALTER TABLE `recipe_votes`
  ADD CONSTRAINT `recipe_votes_ibfk_1` FOREIGN KEY (`recipe_id`) REFERENCES `recipe_posts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
